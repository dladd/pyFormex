...
.. automodule:: arraytools
   ...
   :members: niceLogSize,niceNumber,sind,cosd,tand,dotpr,length,normalize,projection,norm,solveMany,permutations,inside,isClose,unitVector,rotationMatrix,rotMatrix,rotationAnglesFromMatrix,growAxis,reverseAxis,addAxis,stack,checkArray,checkArray1D,checkUniqueNumbers,readArray,writeArray,cubicEquation,unique1dOrdered,renumberIndex,inverseUniqueIndex,sortByColumns,uniqueRows
