...
- Wire stent: This screenshot shows the main stages during the
  generation of the wire stent geometry.

.. image:: images/WS_screenshot.png
   :align: center

- Surface mesh manipulations: The top viewports show a stent device
...
- Fluid simulations: pyFormex can also be used to create grids for
...
- Slicing operation: In this example pyFormex was used to slice a
...
- `efika_smartbook`_: A Genesi Efika MX Smartbook (ARM Cortex-A8) running pyFormex.
