...
\begin{figure} [ht]
   ...
   \begin{latexonly}
	...
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step01.png}
	\begin{center}
	\vspace{-3ex}
	(a)
	\vspace{1ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {3.5cm}
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step02.png}
	\begin{center}
	\vspace{-3ex}
	(b)
	\vspace{1ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {3.5cm}
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step03.png}
	\begin{center}
	\vspace{-3ex}
	(c)
	\vspace{1ex}
...
\begin{figure} [ht]
   ...
   \begin{latexonly}
	\hspace{0.1cm}
	\begin{minipage} [c] [] [c]{3.5cm} 
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step04.png}
	\begin{center}
	\vspace{-3ex}
	(a)
	\vspace{1ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {3.5cm}
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step07.png}
	\begin{center}
	\vspace{-3ex}
	(b)
	\vspace{1ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {3.5cm}
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step09.png}
	\begin{center}
	\vspace{-3ex}
	(c)
	\vspace{1ex}
...
Subsequently, a mirrored copy of the base cell is generated. Both Formices are translated to their appropriate side by side position with the \code{translate()}-option and form the complete extended base module with 4 by 4 dimensions as depicted in Figure \ref{BASE}. Furthermore, both Formices are defined as an attribute of the \code{DoubleHelixStent} class by the \code{self}-statement, allowing their use after every \code{DoubleHelixStent} initialisation. Such further use is impossible with local variables, such as for example the \code{NE} and \code{SE} Formices.
%
...
\begin{figure} [ht]
   ...
   \begin{latexonly}
	...
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step10.png}
	\begin{center}
	\vspace{-3ex}
	(a)
	\vspace{1ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {5.5cm}
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step11.png}
	\begin{center}
	\vspace{-3ex}
	(b)
	\vspace{1ex}
...
\begin{figure} [ht]
   ...
   \begin{latexonly}
	\hspace{0.1cm}
	\begin{minipage} [c] [] [c]{5.5cm} 
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step12.png}
	\begin{center}
	\vspace{-3ex}
	%(a)
	\vspace{1ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {5.5cm}
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step13.png}
	\begin{center}
	\vspace{-3ex}
	%(b)
	\vspace{1ex}
...
\begin{figure} [ht]
   ...
   \begin{latexonly}
	\hspace{0.1cm}
	\begin{minipage} [c] [] [c]{5.5cm} 
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step16.png}
	\begin{center}
	\vspace{-3ex}
	(a)
	\vspace{1ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {5.5cm}
	\includegraphics [width =\textwidth] {images/WireStentDemot2Step15.png}
	\begin{center}
	\vspace{-3ex}
	(b)
	\vspace{1ex}
...
\begin{figure} [H]
   ...
   \begin{latexonly}
	\hspace{0.1cm}
	\begin{minipage} [c] [] [c]{5.5cm} 
	\includegraphics [width =\textwidth] {images/WireStentD16L40d22n6b25.png}
	\begin{center}
	\vspace{-3ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {5.5cm}
	\includegraphics [width =\textwidth] {images/WireStentD16L40d22n6b50.png}
	\begin{center}
	\vspace{-3ex}
...
\hspace{0.1cm}
	\begin{minipage} [c] [] [c]{5.5cm} 
	\includegraphics [width =\textwidth] {images/WireStentD16L40d22n10b25.png}
	\begin{center}
	\vspace{-3ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {5.5cm}
	\includegraphics [width =\textwidth] {images/WireStentD16L40d22n10b50.png}
	\begin{center}
	\vspace{-3ex}
...
\hspace{0.1cm}
	\begin{minipage} [c] [] [c]{5.5cm} 
	\includegraphics [width =\textwidth] {images/WireStentD32L40d22n6b25.png}
	\begin{center}
	\vspace{-3ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {5.5cm}
	\includegraphics [width =\textwidth] {images/WireStentD32L40d22n6b50.png}
	\begin{center}
	\vspace{-3ex}
...
\hspace{0.1cm}
	\begin{minipage} [c] [] [c]{5.5cm} 
	\includegraphics [width =\textwidth] {images/WireStentD32L40d22n10b25.png}
	\begin{center}
	\vspace{-3ex}
...
\hspace{0.3cm}
\begin{minipage} [c] [] [c] {5.5cm}
	\includegraphics [width =\textwidth] {images/WireStentD32L40d22n10b50.png}
	\begin{center}
	\vspace{-3ex}
