...
Finally, \pyformex is, and will always be, free software. Free, in a sense that you can use, copy and distribute this program in source form under very permissive conditions (see \ref{sec:license}). And as long as none of the contributors need it for a living, we'll keep it gratis as well. 
