...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%SCRIPT%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%voor de programmeercode...
\usepackage{listings}                   % Voor het weergeven van letterlijke text en codelistings (-> verbatim)
\usepackage{textcomp}
\lstset{basicstyle=\scriptsize\sffamily, stringstyle=\ttfamily, numbers=left, language=Python, showstringspaces=false, xleftmargin=1cm, xrightmargin=1cm, breaklines=true, frame=lines, upquote=true}
%het volgende is om te nummeren of juist niet
%dit doen we door bijvoorbeeld:\lstset{style=nonumbers} voor \begin{lstlisting} te plaatsen
