...
You probably expect to find here a short definition of what \pyformex is and what it can do for you. I may have to disappoint you: describing the essence of \pyformex in a few lines is an easy task to do, ecause the program can be (and is being) used for very different tasks. So I will give you two answers here: a short one and a long one.
...
If you find this definition too dull, incomprehensible or just not descriptive enough, read on through this section and look at some of the examples in this manual and on the \pyformex{} website\footnote{\websitelink}. Then you will probably have a better idea of what \pyformex{} is. 
...
\begin{figure}[h]
  ...
  %\htmlimage{scale=0.5}
  \begin{latexonly}
  \includegraphics[width=12cm]{../../examples/WireStent.png}
  \end{latexonly}
  \begin{htmlonly}
