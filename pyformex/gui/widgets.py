...
class SaveImageDialog(FileSelection):
    ...
    def __init__(self,path=None,pattern=None,exist=False,multi=False):
        ...
        self.res = InputCombo("Multiply resolution:",None,choices=[1,2,4,8,16,32])
        ...
        self.res.setToolTip("If not 1, the default resolution is multiplied by the factor")
        ...
        nr += 1
        grid.addWidget(self.res,nr,0,1,2)
        nr += 1
