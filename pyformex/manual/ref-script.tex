% pyformex manual --- script --- CREATED WITH py2ptex.py: DO NOT EDIT
% $Id$
% (C) B.Verhegghe
...
\subsection{Exit class: Exception raised to exit from a running script.}
...
\subsection{ExitAll class: Exception raised to exit pyFormex from a script.}
...
\subsection{ExitSeq class: Exception raised to exit from a sequence of scripts.}
...
\subsection{TimeOut class: Exception raised to timeout from a dialog widget.}
...
\subsection{Functions defined in the script module}
...
\begin{funcdesc}{processArgs}{args}
