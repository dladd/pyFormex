...
\begin{funcdesc}{askItems}{items,caption=None,timeout=None}
...
\begin{funcdesc}{askFilename}{cur=None,filter="All files (*.*)",exist=True,multi=False}
...
\begin{funcdesc}{askNewFilename}{cur=None,filter="All files (*.*)"}
...
\begin{funcdesc}{removeHighlights}{}
