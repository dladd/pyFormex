...
chdir(__file__)
\end{verbatim}
When executing a script, \pyf sets the name of the script file in a variable \var{__file__} passed with the global variables to the execution environment of the script.
