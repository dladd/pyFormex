% pyformex manual --- widgets --- CREATED WITH py2ptex.py: DO NOT EDIT
% $Id$
% (C) B.Verhegghe
...
\modulesynopsis{A collection of custom widgets used in the pyFormex GUI}
...
\subsection{FileSelection class: A file selection dialog widget.}
...
\subsection{ProjectSelection class: A file selection dialog specialized for opnening projects.}




The ProjectSelection class has this constructor: 

\begin{classdesc}{ProjectSelection}{path=None,pattern=None,exist=False,compression=0}
Create the dialog.
...
\subsection{SaveImageDialog class: A file selection dialog with extra fields.}
...
\subsection{ImageViewerDialog class: }
...
\subsection{AppearenceDialog class: A dialog for setting the GUI appearance.}
...
\subsection{DockedSelection class: A widget that is docked in the main window and contains a modeless}
...
\subsection{ModelessSelection class: A modeless dialog for selecting one or more items from a list.}
...
\subsection{Selection class: A dialog for selecting one or more items from a list.}
...
\subsection{InputItem class: A single input item, usually with a label in front.}
...
\begin{classdesc}{InputItem}{name=None}
...
\subsection{InputInfo class: An unchangeable input item.}
...
\begin{classdesc}{InputInfo}{name,value}
...
\subsection{InputString class: A string input item.}
...
\begin{classdesc}{InputString}{name,value}
...
\subsection{InputText class: A scrollable text input item.}
...
\begin{classdesc}{InputText}{name,value}
...
\subsection{InputBool class: A boolean input item.}
...
\begin{classdesc}{InputBool}{name,value}
...
\subsection{InputCombo class: A combobox InputItem.}
...
\begin{classdesc}{InputCombo}{name,choices,default}
...
\subsection{InputRadio class: A radiobuttons InputItem.}
...
\begin{classdesc}{InputRadio}{name,choices,default,direction='h'}
...
\subsection{InputPush class: A pushbuttons InputItem.}
...
\begin{classdesc}{InputPush}{name,choices,default=None,direction='h'}
...
\subsection{InputInteger class: An integer input item.}
...
\begin{classdesc}{InputInteger}{name,value,None}
...
\subsection{InputFloat class: An float input item.}
...
\begin{classdesc}{InputFloat}{name,value}
...
\subsection{InputSlider class: An integer input item using a slider.}
...
\begin{classdesc}{InputSlider}{name,value,None}
...
\subsection{InputFSlider class: A float input item using a slider.}
...
\begin{classdesc}{InputFSlider}{name,value,None}
Creates a new integer input slider.
...
\subsection{InputColor class: A color input item.}
...
\begin{classdesc}{InputColor}{name,value}
...
\subsection{InputDialog class: A dialog widget to set the value of one or more items.}
...
\subsection{NewInputDialog class: A dialog widget to set the value of one or more items.}
...
\begin{classdesc}{NewInputDialog}{items,caption=None,parent=None,flags=None,actions=None,default=None,report_pos=False}
Creates a dialog which asks the user for the value of items.
...
\subsection{TableModel class: A table model that represent data as a two-dimensional array of items.}
...
\begin{classdesc}{TableModel}{data,chead=None,rhead=None,parent=None}
...
\subsection{Table class: A dialog widget to show two-dimensional arrays of items.}
...
\begin{classdesc}{Table}{data,chead=None,rhead=None,caption=None,parent=None,actions=[(303, (304, (305, (306, (307, (309, (310, (311, (312, (313, (314, (315, (316, (317, (7, '('), (319, (303, (304, (305, (306, (307, (309, (310, (311, (312, (313, (314, (315, (316, (317, (3, "'OK'"))))))))))))))), (12, ',')), (8, ')')))))))))))))))],default='OK'}
...
\subsection{TableDialog class: A dialog widget to show two-dimensional arrays of items.}
...
\begin{classdesc}{ButtonBox}{name,choices,funcs}
...
\begin{classdesc}{ComboBox}{name,choices,func}
...
\subsection{BaseMenu class: A general menu class.}
...
\subsection{Menu class: A popup/pulldown menu.}
...
\subsection{MenuBar class: A menu bar allowing easy menu creation.}
...
\subsection{DAction class: A DAction is a QAction that emits a signal with a string parameter.}
...
\subsection{ActionList class: Menu and toolbar with named actions.}
...
\subsection{Functions defined in the widgets module}
...
\begin{funcdesc}{messageBox}{message,level='info',choices=[(303, (304, (305, (306, (307, (309, (310, (311, (312, (313, (314, (315, (316, (317, (3, "'OK'")))))))))))))))],timeout=None}
...
\begin{funcdesc}{textBox}{text,type=None,choices=[(303, (304, (305, (306, (307, (309, (310, (311, (312, (313, (314, (315, (316, (317, (3, "'OK'")))))))))))))))]}
