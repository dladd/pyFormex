...
\begin{classdesc}{InputDialog}{items,caption=None,parent=None,flags=None,actions=None,default=None}
...
\begin{funcdesc}{timedOut}{}
Returns True if the result code was set to TIMEOUT
\end{funcdesc}

\begin{funcdesc}{show}{timeout=None,timeoutfunc=None}
Show the dialog.
...
\begin{funcdesc}{acceptData}{result=ACCEPTED}
...
\begin{funcdesc}{getResult}{timeout=None}
...
\begin{classdesc}{Table}{data,chead=None,rhead=None,caption=None,parent=None,actions=[(!!(319, (303, (304, (305, (306, (307, (309, (310, (311, (312, (313, (314, (315, (316, (317, (3, "'OK'"))))))))))))))), (12, ','))!!)],default='OK'}
...
\begin{funcdesc}{messageBox}{message,level='info',choices=['OK'],default=None,timeout=None}
...
\begin{funcdesc}{textBox}{text,type=None,choices=['OK']}
