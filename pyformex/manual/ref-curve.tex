...
\begin{funcdesc}{approx}{ndiv=N_approx}
...
\subsection{Arc3 class: A class representing a circular arc.}




The Arc3 class has this constructor: 

\begin{classdesc}{Arc3}{pts}
...
\subsection{Arc class: A class representing a circular arc.}




The Arc class has this constructor: 

\begin{classdesc}{Arc}{pts}
Create a circular arc.
...
\subsection{Functions defined in the curve module}



\begin{funcdesc}{vectorPairAngle}{v1,v2}
