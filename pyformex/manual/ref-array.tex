...
\begin{funcdesc}{normalize}{A,axis=???}
...
\begin{funcdesc}{projection}{A,B,axis=???}
...
\begin{funcdesc}{growAxis}{a,size,axis=???,fill=0}
Grow a single array axis to the given size and fill with given value.

\end{funcdesc}


\begin{funcdesc}{reverseAxis}{a,axis=???}
